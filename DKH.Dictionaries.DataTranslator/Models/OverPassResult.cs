...
{
    private OverPassResult()
    {
        Elements = new List<OverPassElement>();
    }

    public OverPassResult(string version, string generator, OverPassOsm3S osm3S, List<OverPassElement> elements) : base()
    {
        Version = version;
        Generator = generator;
        Osm3S = osm3S;
...
public class OverPassElement
{
    ...
    public OverPassElement(OverPassElementTypeEnum type, long id, double lat, double lon,
    ...
    [JsonProperty("type")] public OverPassElementTypeEnum Type { get; private set; } = default!;
